export const blogPosts = [
    {
        ...
        content: [
            ...
            'Mesela benim Grafik Tasarımı bölümümde İngilizce eğitim veren ve dersleri saydırabileceğimiz yalnızca iki okul seçeneği vardı. Ulusal Ajans\'ın Turna Portal sistemi üzerinden tercihlerimizi yaptık ve tüm bölümden sadece iki kişi seçilebildik. Fakat süreç bunla bitmedi, karşı okulun uyguladığı portfolyo değerlendirme sisteminde diğer arkadaşım ne yazık ki kabul alamadı. Bu yüzden Güzel Sanatlar Fakültesi'ndeyseniz ve Turna Portal üzerinden Erasmus'a gitmeye hak kazandıysanız, karşı okulu ikna edecek bir portfolyo hazırlamanız da gerekiyor. Sonuç olarak, ilk yılımdan beri derslere ağır inekleyip ortalamamı yüksek tuttuğum için bu sene Bilkent Grafik Tasarım Bölümü\'nde Erasmus’a gidebilen tek kişi bendim. Eğer siz de böyle az sayıda kontenjanı olan bir bölümdeyseniz akademik olarak işi baştan sıkı tutmanız zaruri.',
            'İşletme gibi bölümlerde çok daha düşük puanlarla bile Erasmus\'a gidilebiliyorken Grafik Tasarım gibi yaratıcı alanlarda yaşanan bu kontenjan kıtlığı oldukça üzücü. Dönem arkadaşım Melih ile ilk senemizde bu adaletsizliği fark etmiş, hocalarımıza durumun vahametini gösteren veriler toplayıp bir sunum yapmıştık. Benim dönemime kadar somut bir değişiklik yaşanmasa bile bazı sayın hocalarımın bu konuda kişisel olarak çaba sarf ettiklerini duydum. Umarım İç Mimarlık ve Grafik Tasarım gibi Erasmus okul listesi dar olan bölümlere gelecekte daha fazla imkan sunulur.',
            {
                type: 'image',
            ...
            'Polonya’ya geldiğim ilk haftalar hava -15 dereceydi. Sürekli buz tutan yolların yanında kapalı ve gri gökyüzü, ilk başta Polonya'ya geldiğime beni pişman etti. Şansıma son 13 yılın en sert kışına denk gelmiştim. Tabii kış mevsiminin bu buruk havası herkesi aynı etkilemiyordur; örneğin buradaki hocalarımdan Adam Pękalski, kapalı havaların kendisini mutlu ettiğinden bahsetmişti. Bana pek ters bir durum. Ankara’nın gri iklimine alışkın birilerini bile buranın gökyüzü zaman zaman yorabilir. Eğer hava durumu ruh halinizi doğrudan etkiliyorsa Polonya ilk aylarda yüzünüzü pek güldürmeyebilir.',
            {
                ...
                caption: 'Donmuş Baltık Denizi sahili.'
            },
            'Neyse ki baharın gelmesiyle havalar epey ısındı ve çevrenin güzelliği ortaya çıktı. Gdańsk ve genel olarak Polonya; son derece iyi planlanmış, nizami ve düzenli yerler. Özellikle yaşadığım kuzey bölgesinin (Trójmiasto) ormanlarına ve sahillerine bayıldım. Buranın kumsalları Türkiye’dekinden çok farklı, sahil ve devasa ormanlık alanlar iç içe geçmiş durumda. Łeba’daki kumulları gezmek harika bir deneyimdi.',
            {
                ...
                caption: 'Gdańsk\'ın şehir merkezi.'
            },
            {
                type: 'image',
                src: '/images/blog-erasmus-gdansk/gdansk-center-2.jpg',
                alt: 'Gdańsk Merkezi 2',
                caption: 'Tuğla renginin baskın olduğu Gdańsk sokakları.'
            },
            {
                type: 'image',
                src: '/images/blog-erasmus-gdansk/leba.jpg',
                alt: 'Leba Kumulları',
                caption: 'Łeba’daki kumullar.'
            },
            {
                type: 'image',
                src: '/images/blog-erasmus-gdansk/malbork-castle.jpg',
                alt: 'Malbork Kalesi',
                caption: 'Malbork Kalesi çevresi.'
            },
            'Ülkedeki yaşam standartlarına gelirsek, iki büyük avantaj öne çıkıyor:',
            {
                type: 'list',
                items: [
                    ...
                    'Alışveriş: Marketler oldukça elverişli. Geç saatlere kadar açık olan Żabka ve çoğu sokakta görebileceğiniz Biedronka gibi marketlerden temel ihtiyaçlarınızı rahatça karşılayabiliorsunuz. Özellikle et ve süt ürünlerinin Türkiye’ye kıyasla daha ucuz olduğunu söyleyebilirim.'
                ]
            },
            ...
            'Bilkent Üniversitesi\'ndeki değerli hocalarım Marek Brzozowski ve Orhan Kavas\'tan etkilenip Polish School of Poster (Polonya Afiş Okulu) üzerine epey merak salmıştım. Bu yüzden Erasmus tercih vakti geldiğinde Polonya’ya kabul edildiğim için çok mutluyum.',
            {
                ...
                caption: 'Academy of Fine Arts in Gdańsk (Gdańsk Güzel Sanatlar Akademisi).'
            },
            'İlk iki hafta sınıfları gezerek, ders içeriklerini inceleyerek ve hocalara portfolyomu göstererek geçirdim. İki hafta sonunda istediğim derslerini ve zorunlu olan Lehçe dersini listeme ekleyebildim. Bu süreçte kişisel web sitemin bana çok büyük katkısı oldu, dersine katılmak istediğim hiçbir hocadan ret yemedim. Gidecek arkadaşlara işlerini PDF veya web sitesi üzerinden sunmalarını önerebilirim.',
            'Okulumuz akademik beklentilerimi fazlasıyla karşıladı. Pinterest’e "Polish Poster" yazdığımda tasarımları ilk sırada çıkan Tomasz Bogusławski’den, şehrin dört bir yanında işleri bulunan ve sosyal propaganda konusunda inanılmaz tecrübeli olan Jacek Staniszewski hocamızdan ve tipografi ustası Ada Pawlikowska gibi isimlerden ders alma şansı yakaladım.',
            {
                type: 'image',
                src: '/images/blog-erasmus-gdansk/polish-poster-dictionary.jpg',
                alt: 'Polonya Afiş Okulu Sözlük Çalışması',
                caption: 'Polonya Afiş Okulu\'nun önemli isimlerini derlediğim sözlük çalışması.'
            },
            'Renk kullanımı, görsel hiyerarşi, ne tasarladığının bilincinde olmak ve optik tipografi gibi konularda Türkiye\'de kolay erişemeyeceğimi düşündüğüm bakış açıları edindim. Ayrıca hocaların benim gösterdiğim ilgi karşısında merakımı tatmin etmek için ne kadar çabaladıklarını görmek büyük bir mutluluktu. Diğr bir yandan bu okulun akademik yoğunluğu Bilkent ile kıyaslanınca oldukça hafif, derslere devam ettiğiniz ve işleriniz haftalık geribildirim aldığınız sürece yüksek notlar almak oldukça ulaşılabilir.',
            ...
            'Buna karşın Polonya’dayken en sıkı fıkı olduğum grup Çek ve Slovak arkadaşlarım oldu. İlgi alanlarımızın uyuştuğu bu harika insanlarla pek çok gezi düzenledik, kamplara gittik. Doğaya ve farklı kültürlere olan merakları, saygılı tutumları ve yüksek hitabetleri beni çok etkiledi. Onlarla vakit geçirebildiğim için şanslıyım, umarım bu arkadaşlıklarımız Polonya ile sınırlı kalmaz.',
            {
                ...
                caption: 'Arkadaşlarım ile tipografi, burada "LOVE" yazdığını varsayınız.'
            },
            ...
            'Süreçle ilgili özellikle de vize ve portfolyo hazırlığı konularında sorularınız olursa bana e-posta yoluyla ulaşabilirsiniz. Erasmus yolculuğuna çıkacak herkesin işi rast gitsin, size kolaylıklar dilerim.'
        ]
    },
    {
