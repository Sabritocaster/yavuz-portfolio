export default function About() {
    return (
        <div className="w-full min-h-screen bg-white text-black pt-32 md:pt-48 pb-24 layout-grid debug-layout">

            {/* Image Section - Cols 1-4 on Desktop, Full on Mobile */}
            <div className="w-full col-span-12 md:col-start-1 md:col-span-4 mb-12 md:mb-0">
            ...
            <div className="w-full col-span-12 md:col-start-5 md:col-span-6 flex flex-col justify-center">
                ...
                <div className="mt-auto">
                    <p className="font-medium text-lg">Ankara, Türkiye</p>
